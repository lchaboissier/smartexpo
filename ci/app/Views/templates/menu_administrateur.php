...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Heading -->
            <!-- Nav Item - Profils -->
            <li class="nav-item <?php echo (current_url() == base_url() . 'index.php/admin/compte/lister') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?php echo base_url() . "index.php/admin/compte/lister" ?>">
